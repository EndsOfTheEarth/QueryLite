...
namespace QueryLiteTest.Tests.ConditionTests {
    ...
    [TestClass]
    public sealed class Long_ConditionTests {
        ...
        public async Task TestConditions_Parameters_Async() {
            ...
            await Long_ConditionTests.TestConditions_Async();
        }
        ...
        public static async Task TestConditions_Async() {
            ...
            //
            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt == short.MaxValue)
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
...

            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt == types1.BigInt)
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
            ...
            //
            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt < short.MinValue)
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
...

            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt < types2.BigInt)
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
            ...
            //
            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt.SqlEquals_NonTypeSafe(int.MaxValue))
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
...

            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt.SqlEquals_NonTypeSafe(types1.BigInt))
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
...

            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.BigInt.SqlNotEquals_NonTypeSafe(types1.BigInt))
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
                    ...
                    .Where(
                        table.BigInt.In(
                            Query.NestedSelect(table2.BigInt)
                                .From(table2)
                                .Where(table2.BigInt == types1.BigInt)
                        )
                    )
                    .OrderBy(table.BigInt.ASC)
                    .ExecuteAsync(TestDatabase.Database);
