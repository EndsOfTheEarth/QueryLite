...
namespace Benchmarks {
    ...
    public class SelectOneThousandRowBenchmarks {
        ...
        [Benchmark]
        public void EF_Core_One_Thousand_Row_Select_No_Change_Tracking() {

            for(int index = 0; index < _iterations; index++) {

                using TestContext context = Databases.ContextFactory.CreateDbContext();    //Context goes here as it seems the change tracking caches records from previous iteration
