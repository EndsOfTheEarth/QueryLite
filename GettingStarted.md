...
namespace Northwind.Tables {
    ...
    public sealed class CustomerTable : ATable {
        ...
        private CustomerTable() : base(tableName: "Customer", schemaName: "dbo") {
            ...
            ContactName = new NullableColumn<string>(this, name: "ContactName");
            ContactTitle = new NullableColumn<string>(this, name: "ContactTitle");
            Address = new NullableColumn<string>(this, name: "Address");
            City = new NullableColumn<string>(this, name: "City");
            Region = new NullableColumn<string>(this, name: "Region");
            PostalCode = new NullableColumn<string>(this, name: "PostalCode");
            Country = new NullableColumn<string>(this, name: "Country");
            Phone = new NullableColumn<string>(this, name: "Phone");
            Fax = new NullableColumn<string>(this, name: "Fax");
        }
    }
    ...
    public sealed class OrderTable : ATable {
        ...
        private OrderTable() : base(tableName: "Order", schemaName: "dbo", enclose: true) {
            ...
            CustomerId = new NullableColumn<string>(this, name: "CustomerId");
            EmployeeId = new NullableColumn<int>(this, name: "EmployeeId");
            ...
            ShipVia = new NullableColumn<int>(this, name: "ShipVia");
            Freight = new NullableColumn<decimal>(this, name: "Freight");
            ShipName = new NullableColumn<string>(this, name: "ShipName");
            ShipAddress = new NullableColumn<string>(this, name: "ShipAddress");
            ShipCity = new NullableColumn<string>(this, name: "ShipCity");
            ShipRegion = new NullableColumn<string>(this, name: "ShipRegion");
            ShipPostalCode = new NullableColumn<string>(this, name: "ShipPostalCode");
            ShipCountry = new NullableColumn<string>(this, name: "ShipCountry");
        }
    }
}
```