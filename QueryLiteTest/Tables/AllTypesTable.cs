...
namespace QueryLiteTest.Tables {
    ...
    public sealed class AllTypesTable : ATable {
        ...
        private AllTypesTable() : base(tableName: "AllTypes", schemaName: "dbo") {
            ...
            Id = new Column<AllTypesId, int>(this, columnName: "taId", isAutoGenerated: true);
            Guid = new Column<Guid>(this, columnName: "taGuid");
            String = new Column<string>(this, columnName: "taString", length: new(100));
            ...
            Bytes = new Column<byte[]>(this, columnName: "taBytes", length: ColumnLength.MAX);
