...
public sealed class CustomerTable : ATable {
    ...
    private CustomerTable() : base(tableName:"Customer", schemaName: "dbo") {
        ...
        ContactName = new NullableColumn<string>(this, name: "ContactName", length: new(30));
        ContactTitle = new NullableColumn<string>(this, name: "ContactTitle", length: new(30));
        Address = new NullableColumn<string>(this, name: "Address", length: new(60));
        City = new NullableColumn<string>(this, name: "City", length: new(15));
        Region = new NullableColumn<string>(this, name: "Region", length: new(15));
        PostalCode = new NullableColumn<string>(this, name: "PostalCode", length: new(10));
        Country = new NullableColumn<string>(this, name: "Country", length: new(15));
        Phone = new NullableColumn<string>(this, name: "Phone", length: new(24));
        Fax = new NullableColumn<string>(this, name: "Fax", length: new(24));
    }
}
...
public sealed class OrderTable : ATable {
    ...
    private OrderTable() : base(tableName:"Order", schemaName: "dbo", enclose: true) {
        ...
        CustomerId = new NullableColumn<CustomerId, string>(this, name: "CustomerId", length: new(5));
        EmployeeId = new NullableColumn<EmployeeId, int>(this, name: "EmployeeId");
        OrderDate = new NullableColumn<DateTime>(this, name: "OrderDate");
        RequiredDate = new NullableColumn<DateTime>(this, name: "RequiredDate");
        ShippedDate = new NullableColumn<DateTime>(this, name: "ShippedDate");
        ShipVia = new NullableColumn<ShipperId, int>(this, name: "ShipVia");
        Freight = new NullableColumn<decimal>(this, name: "Freight");
        ShipName = new NullableColumn<string>(this, name: "ShipName", length: new(40));
        ShipAddress = new NullableColumn<string>(this, name: "ShipAddress", length: new(60));
        ShipCity = new NullableColumn<string>(this, name: "ShipCity", length: new(15));
        ShipRegion = new NullableColumn<string>(this, name: "ShipRegion", length: new(15));
        ShipPostalCode = new NullableColumn<string>(this, name: "ShipPostalCode", length: new(10));
        ShipCountry = new NullableColumn<string>(this, name: "ShipCountry", length: new(15));
    }
}
```
