...
public sealed class CustomerTable : ATable {
    ...
    private CustomerTable() : base(tableName:"Customer", schemaName: "dbo") {
        CustomerId = new Column<StringKey<ICustomer>>(this, columnName: "CustomerId", isPrimaryKey: true, length: 5);
...
public sealed class OrderTable : ATable {
    ...
    private OrderTable() : base(tableName:"Order", schemaName: "dbo") {
        OrderId = new Column<IntKey<IOrder>>(this, columnName: "OrderId", isPrimaryKey: true, isAutoGenerated: true, length: null);
