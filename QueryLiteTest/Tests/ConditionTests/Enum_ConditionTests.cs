...
namespace QueryLiteTest.Tests.ConditionTests {
    ...
    [TestClass]
    public sealed class Enum_ConditionTests {
        ...
        public async Task TestConditions_Parameters_Async() {
            ...
            await Enum_ConditionTests.TestConditions_Async();
        }
        ...
        public static async Task TestConditions_Async() {
            ...
            types1.Enum = AllTypesEnum.A;
            types2.Enum = AllTypesEnum.B;
            types3.Enum = AllTypesEnum.C;
            ...
            //
            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.Enum == (AllTypesEnum)100000)
                    .OrderBy(table.Id.ASC)
                    .ExecuteAsync(TestDatabase.Database);
            ...
            //
            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.Enum.SqlEquals_NonTypeSafe((AllTypesEnum)100000))
                    .OrderBy(table.Id.ASC)
                    .ExecuteAsync(TestDatabase.Database);
...

            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.Enum.SqlEquals_NonTypeSafe(types1.Enum))
                    .OrderBy(table.Id.ASC)
                    .ExecuteAsync(TestDatabase.Database);
...

            {
                QueryResult<AllTypesInfo> result = await Query
                    ...
                    .From(table)
                    .Where(table.Enum.SqlNotEquals_NonTypeSafe(types1.Enum))
                    .OrderBy(table.Id.ASC)
                    .ExecuteAsync(TestDatabase.Database);
