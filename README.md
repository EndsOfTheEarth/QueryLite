...
public sealed class CustomerTable : ATable {
    ...
    private CustomerTable() : base(tableName:"Customer", schemaName: "dbo") {
        CustomerId = new Column<CustomerId, string>(this, columnName: "CustomerId", length: 5);
...
public sealed class OrderTable : ATable {
    ...
    private OrderTable() : base(tableName:"Order", schemaName: "dbo", enclose: true) {
        OrderId = new Column<OrderId, int>(this, columnName: "OrderId", isAutoGenerated: true, length: null);
        CustomerId = new NullableColumn<CustomerId, string>(this, columnName: "CustomerId", length: 5);
        EmployeeId = new NullableColumn<EmployeeId, int>(this, columnName: "EmployeeId", length: null);
        ...
        ShipVia = new NullableColumn<ShipperId, int>(this, columnName: "ShipVia", length: null);
