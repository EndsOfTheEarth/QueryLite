...
`PrimaryKey` and `ForeignKey` attributes can be added to columns to be included in the output documentation.
...
public sealed class TerritoryTable : ATable {
    ...
    [ForeignKey("fk_Territory_Region", primaryKeyTable: typeof(RegionTable))]
