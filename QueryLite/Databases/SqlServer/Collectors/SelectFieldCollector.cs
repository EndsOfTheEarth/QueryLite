...
namespace QueryLite.Databases.SqlServer {
    ...
    internal sealed class SqlServerSelectFieldCollector : IResultRow {
        ...
        public SqlServerSelectFieldCollector(IDatabase database, IParametersBuilder? parameterBuilder, bool useAlias, StringBuilder sql) {
            _database = database;
        ...
        private VALUE Add<VALUE>(AColumn<VALUE> column) where VALUE : notnull {
            ...
            SqlServerHelper.AppendColumnName(_sql!, column);
